...
async def play(_, message: Message):
    ...
    lel = await message.reply("🔄 **𝑷𝒓𝒐𝒄𝒆𝒔𝒔𝒊𝒏𝒈...**")
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "**𝑲𝒊𝒓𝒂 𝑴𝒖𝒔𝒊𝒄 𝑨𝒔𝒔𝒊𝒔𝒕𝒂𝒏𝒕 𝑱𝒐𝒊𝒏 𝑻𝒉𝒊𝒔 𝑮𝒓𝒐𝒖𝒑 𝑭𝒐𝒓 𝑷𝒍𝒂𝒚 𝑴𝒖𝒔𝒊𝒄 🎧 🎼**")
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/005ece6df39d4cdda32e5.jpg"
        ...
        await lel.edit("🔎 **𝑭𝒊𝒏𝒅𝒊𝒏𝒈 𝑻𝒉𝒆 𝑺𝒐𝒏𝒈...**")
        query = message.text.split(None, 1)[1]
        # print(query)
        await lel.edit("🎵 **𝑷𝒓𝒐𝒄𝒆𝒔𝒔𝒊𝒏𝒈 𝑺𝒐𝒖𝒏𝒅𝒔...**")
        try:
